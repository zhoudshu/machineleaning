...
fprintf('lambda\t test Error %f\t%f\n',lambda,error_test); 

%3.5 Optional (ungraded) exercise: Plotting curves with randomly selected examples
[error_train, error_val] = ...
...
fprintf('Random Polynomial Regression (lambda = %f)\n\n', lambda);
fprintf('# Training Examples\tTrain Error\tCross Validation Error\n');
for i = 1:m
    fprintf('  \t%d\t\t%f\t%f\n', i, error_train(i), error_val(i));
end
